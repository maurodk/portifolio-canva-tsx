...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Aplicativo de gerenciamento de tarefas com interface intuitiva e sincronização em tempo real.',
    ...
    },
    {
      ...
      description: 'API robusta para consulta de dados meteorológicos com cache inteligente e documentação completa.',
    ...
    <section id="projects" className="section-padding">
      <div className="container mx-auto">
        ...
        <div className="text-center mt-12 animate-fade-in-up">
          <Button size="lg" variant="outline" className="hover-scale hover-glow">
            Ver Mais Projetos
